#This script employs the chooseR iterative subsampling procedure on the microglial cluster
#chooseR-identified clusters will be annotated in a later script

#This dataset was too large even for our HPC resources, so it was down-sampled to 
#about 1/8 in size
...
dir.create("chooseR/microglia")

obj <- obj[, sample(colnames(obj), size = 12000, replace = F)]
